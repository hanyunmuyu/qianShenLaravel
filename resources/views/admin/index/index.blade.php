    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    @foreach($permissionList as $permission)
                        @if($permission->subList)
                            <li data-name="id-{{$permission->id}}" class="layui-nav-item">
                                ...
                                <dl class="layui-nav-child">
                                    @foreach($permission->subList as $p)
                                        <dd data-name="id-{{$p->id}}"><a
                                                    lay-href="{{admin_url($p->path)}}">{{$p->title}}</a></dd>
                                    @endforeach
                                </dl>
                            </li>
                        @endif
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="{{admin_url('/dashboard')}}" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
